...
// line 1 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
// line 9 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
{
	return new short [] {
	    1,   63, -128,  127, -128,    0,    1,   63,   64,  127,    0
	};
}
...
{
	return new short [] {
	  513,  575,  896, 1151,  896, 1024, 1088, 1151, 1537, 1599, 1793, 1855,
	 2049, 2111,    0
	};
}
...
// line 10 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
// line 37 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
// line 40 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
;		int _mid;
	...
	case 0: {
		...
		if ( 
// line 25 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen-- > 0)  ) _widec += 256;
		break;
	}
	case 1: {
		...
		if ( 
// line 26 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen <= 0)  ) _widec += 256;
		break;
	}
	case 2: {
		_widec = 1152 + (data[p] - -128);
		if ( 
// line 25 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen-- > 0)  ) _widec += 256;
		if ( 
// line 26 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen <= 0)  ) _widec += 512;
		...
		while ( _nacts-- > 0 )
	{
			...
			{
	case 0:
// line 24 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
	{ lablen = ((int) data[p]) & 0xff; }
	break;
// line 312 "src/java/inet/data/dns/DNSDomainParser.java"
			}
		}
	}
...
// line 41 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
// line 49 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"

// line 343 "src/java/inet/data/dns/DNSDomainParser.java"
...
{
	return new short [] {
	    1,   63,   48,   57,   65,   90,   97,  122,   45,   45,   48,   57,
	   65,   90,   95,   95,   97,  122,    1,   44,   45,   45,   46,   47,
	   48,   57,   58,   63,   65,   90,   95,   95,   97,  122,    0
	};
}
...
{
	return new short [] {
	  513,  575, 1072, 1081, 1089, 1114, 1121, 1146, 1069, 2655, 1072, 1081,
	 1089, 1114, 1121, 1146, 2655, 3117, 3373, 3629,  513,  556,  558,  559,
	  570,  575, 1089, 1114, 1121, 1146, 3120, 3129, 3376, 3385, 3632, 3641,
	    0
	};
}
...
{
	return new byte [] {
	    0,    1,    2,    3,    3,    1,    4,    4,    2,    3,    3,    1,
	    4,    4,    0,    4,    0,    0,    0,    3,    3,    2,    0,    2,
	    1,    0
	};
}
...
// line 50 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
...
// line 86 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"


    
// line 509 "src/java/inet/data/dns/DNSDomainParser.java"
	{
	cs = hostname_start;
	}

// line 89 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
    
// line 516 "src/java/inet/data/dns/DNSDomainParser.java"
	{
	int _klen;
	int _trans = 0;
	int _widec;
...
;		int _mid;
	...
	case 0: {
		_widec = 640 + (data[p] - -128);
		if ( 
// line 66 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen-- > 0)  ) _widec += 256;
		break;
	}
	case 1: {
		_widec = 128 + (data[p] - -128);
		if ( 
// line 67 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen <= 0)  ) _widec += 256;
		break;
	}
	case 2: {
		_widec = 1152 + (data[p] - -128);
		if ( 
// line 68 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 underscores  ) _widec += 256;
		break;
	}
	case 3: {
		_widec = 2688 + (data[p] - -128);
		if ( 
// line 66 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen-- > 0)  ) _widec += 256;
		if ( 
// line 67 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen <= 0)  ) _widec += 512;
	...
	case 4: {
		_widec = 1664 + (data[p] - -128);
		if ( 
// line 66 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 (lablen-- > 0)  ) _widec += 256;
		if ( 
// line 68 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
 underscores  ) _widec += 512;
		break;
	}
				}
				break;
		...
		while ( _nacts-- > 0 )
	{
			...
			{
	case 0:
// line 65 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
	{ lablen = ((int) data[p]) & 0xff; }
	break;
	case 1:
// line 69 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
	{ letter = true; }
	break;
// line 670 "src/java/inet/data/dns/DNSDomainParser.java"
			}
		}
	}
...
// line 90 "src/ragel/inet/data/dns/DNSDomainParser.java.rl"
